...
public class HumidityActivity extends AppCompatActivity {
    ...
    private LineData generateDataLine() {
        ...
        LineDataSet d = new LineDataSet(values, "Humidity (°C)");
        d.setDrawCubic(true);
        d.setDrawCircles(false);
        d.setDrawValues(false);
        d.setLineWidth(5f);
        d.setHighLightColor(Color.rgb(244, 117, 117));
        d.setColor(MATERIAL_COLORS[0]);
        d.setCircleColor(MATERIAL_COLORS[0]);
    ...
    private BarData generateDataBar() {
        ...
        BarDataSet d = new BarDataSet(entries, "Avg. Humidity (%)");
        d.setColors(Collections.singletonList(MATERIAL_COLORS[0]));
