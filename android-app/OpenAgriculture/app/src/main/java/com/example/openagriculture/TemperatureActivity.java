...
public class TemperatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<OAData> week = getIntent().getParcelableExtra("week");

        Log.e("HAHA", "HIHI");
        Log.e("HAHA", this.week.toString());
    ...
    private LineData generateDataLine() {
        ...
        LineDataSet d = new LineDataSet(values, "Temperature (°C)");
        d.setDrawCubic(true);
        d.setDrawCircles(false);
        d.setDrawValues(false);
        d.setLineWidth(5f);
        d.setHighLightColor(Color.rgb(244, 117, 117));
        d.setColor(MATERIAL_COLORS[2]);
        d.setCircleColor(MATERIAL_COLORS[2]);
    ...
    private BarData generateDataBar() {
        ...
        BarDataSet d = new BarDataSet(entries, "Avg. Temperature (°C)");
        d.setColors(Collections.singletonList(MATERIAL_COLORS[2]));
